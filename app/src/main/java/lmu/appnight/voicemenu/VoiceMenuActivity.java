package lmu.appnight.voicemenu;
...
// Good practice to pass through, for options menu.
        ...
        if (featureId == WindowUtils.FEATURE_VOICE_COMMANDS) {
            switch (item.getItemId()) {
                ...
                case R.id.menu_coder1:
                    mPicture = 1;
                    break;
                case R.id.menu_coder2:
                    mPicture = 2;
                    break;
                case R.id.menu_coder3:
                    mPicture = 3;
                    break;
                case R.id.menu_coder4:
                    mPicture = 4;
                    break;
                case R.id.menu_coder5:
                    mPicture = 5;
                    break;
    ...
    private int getImageResource() {
        switch (mPicture) {
            case 1:
                return R.drawable.codemonkey1;
            case 2:
                return R.drawable.codemonkey2;
            case 3:
                return R.drawable.codemonkey3;
            case 4:
                return R.drawable.codemonkey4;
            case 5:
                return R.drawable.codemonkey5;
            case 6:
                return R.drawable.product;
            default:
                return R.drawable.designer;
        }
    }
}